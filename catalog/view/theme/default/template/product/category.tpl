  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <div class="row" style="line-height: 6;">
        <div class="col-md-10" style="float: left;"><h2><?php echo $heading_title; ?></h2></div>
        <div class="col-md-2 hide" style="float:right;">
    ...
    <!--   <div class="row">
      ...
      <div class="row">
        ...
        <div class="product-layout product-list col-xs-12" style="float: left;">
